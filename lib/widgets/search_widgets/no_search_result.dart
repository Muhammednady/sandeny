...
import 'package:sandeny/widgets/search_widgets/search_details.dart';
...
Widget noSearchResult(BuildContext context, dynamic controller) {
      ...
      children: [
        Padding(
          padding: Get.locale!.languageCode == 'ar'
              ...
              : EdgeInsets.only(
                  top: 20, left: Get.width * 0.10, right: Get.width * 0.1),
          child: searchDetailsWidget(context, controller),
        ),
        Padding(
          padding: Get.locale!.languageCode == 'ar'
              ? EdgeInsets.only(
