...
import 'package:sandeny/app/modules/scheduled_session/controllers/scheduled_session_payment_controller.dart';
...
Widget scheduledSessionBookingDetails(
          ...
          child: Row(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  '${controller.getSSD.data!.price} ${'SAR'.tr}',
                ...
                child: Obx(
                  () => Text(
                    paymentController.showDiscount.value == true
                        ...
                        : '${controller.getSSD.data!.totalPrice!} ${'SAR'.tr}',
                    style: getRegularStyle(color: ColorsManager.blackColor),
                  ),
                ),
              )
