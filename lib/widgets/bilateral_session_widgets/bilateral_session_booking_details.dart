...
Widget bilateralSessionBookingDetails(
    BuildContext context, dynamic controller) {
  var isArabic = Get.locale!.languageCode == 'ar';
  var paymentController = Get.put(BilateralSessionPaymentController());
  return Container(
    width: 315,
    height: 230,
          ...
          child: Row(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  '${controller.getBSD.data!.price} ${'SAR'.tr}',
                ...
                child: Obx(
                  () => Text(
                    paymentController.showDiscount.value == true
                        ...
                        : '${controller.getBSD.data!.totalPrice!} ${'SAR'.tr}',
                    style: getRegularStyle(color: ColorsManager.blackColor),
                  ),
                ),
              )
