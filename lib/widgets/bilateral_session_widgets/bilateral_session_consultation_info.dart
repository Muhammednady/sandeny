...
import '../../app/modules/bilateral_session/controllers/bilateral_session_payment_controller.dart';
import '../../constants/colors_manager.dart';
import '../../constants/fonts_manager.dart';
import '../../constants/images_manager.dart';
import '../../constants/styles_manager.dart';

Widget bilateralSessionConsultationInfo(BuildContext context, controller) {
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: CircleAvatar(
                      ...
                      child: Image.network(
                        controller.getBSD.data!.profileImage!,
                        fit: BoxFit.cover,
                        height: 40,
                        width: 40,
                      ),
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: ListView.separated(
                            ...
                            itemCount:
                                controller.getBSD.data!.specializations!.length,
                              ...
                              return Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    controller.getBSD.data!.specializations!
                                                .last !=
                                            controller.getBSD.data!
                                                .specializations![i]
                                        ? const Text(
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              Text(
                isArabic
                    ? '${controller.getBSD.data!.period} ${'minute'.tr}'
                    : '${controller.getBSD.data!.period} ${'minute'.tr}',
                style: getRegularStyle(
                  color: ColorsManager.blackColor,
                  fontSize: 12,
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  controller.getBSD.data!.startAt!,
                  style: getRegularStyle(
                    color: ColorsManager.blackColor,
                    fontSize: 12,
                  ),
