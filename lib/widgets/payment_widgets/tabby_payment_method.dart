...
Widget tabbyMethod(
    BuildContext context, dynamic paymentController, dynamic appointment) {
  var isArabic = Get.locale!.languageCode == 'ar';
  var price = double.parse(appointment.price).toInt() / 4;
  return Obx(
    () => GestureDetector(
      onTap: () {
                                ...
                                children: [
                                  ...
                                  TextSpan(
                                    text: paymentController
                                                .showDiscount.value ==
                                            true
                                        ? '${double.parse(paymentController.getPaymentCoupon.data!.totalPrice!).toInt() / 4} SAR '
                                        : '${price.toString()} SAR ',
                                    style: const TextStyle(
