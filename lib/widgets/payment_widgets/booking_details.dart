...
import 'add_payment_coupon.dart';

Widget bookingDetails(BuildContext context, dynamic appointment) {
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    GestureDetector(
                      onTap: () {
                        addPaymentCoupon(context, paymentController);
                      },
                ...
                child: Obx(
                  () => Text(
                    paymentController.showDiscount.value == true
                        ? paymentController.getPaymentCoupon.data!.isRate! ==
                                true
                            ? '${paymentController.getPaymentCoupon.data!.discountRate!} %'
                            : '${paymentController.getPaymentCoupon.data!.discountRate!} ${'SAR'.tr}'
                        : '',
                    // : '0 ${'SAR'.tr}',
                    style: getRegularStyle(color: ColorsManager.blackColor),
                  ),
            ...
            children: [
              ...
              Padding(
                ...
                child: Obx(
                  () => Text(
                    paymentController.showDiscount.value == true
                        ? '${paymentController.getPaymentCoupon.data!.totalPrice!} ${'SAR'.tr}'
                        : '${appointment.price!} ${'SAR'.tr}',
                    style: getRegularStyle(color: ColorsManager.blackColor),
                  ),
                ),
