...
import 'booking_bilateral_session_view.dart';

class GetAvailableBSDoctorView extends GetView<BilateralSessionController> {
  const GetAvailableBSDoctorView({Key? key}) : super(key: key);
  @override
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: ButtonsManager.primaryButton(
                                          text: 'booking_bilateralـsession'.tr,
