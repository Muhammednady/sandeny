...
import '../controllers/booking_bilateral_session_controller.dart';

class BookingBilateralSessionView
    extends GetView<BookingBilateralSessionController> {
  const BookingBilateralSessionView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    var isArabic = Get.locale!.languageCode == 'ar';
    var controller = Get.put(BilateralSessionController());
      ...
      body: Column(
        children: [
          ...
          ButtonsManager.primaryButton(
            ...
            onPressed: () {
              appointmentBookingController.getAvailableAppointment();
            },
            context: context,
          )
        ],
