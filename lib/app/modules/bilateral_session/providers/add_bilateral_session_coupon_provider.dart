...
class AddBilateralSessionCouponProvider extends GetConnect {
  static AddBilateralSessionCouponProvider get instance =>
      Get.put(AddBilateralSessionCouponProvider());
  ...
  Future<AddBilateralSessionCoupon> addCoupon({
    required int appointmentId,
    required String couponCode,
  }) async {
    try {
      const url = HttpHelper.baseUrl + HttpHelper.addBilateralSessionCoupon;
      final headers = {
      ...
      if (data['code'] == 1) {
        ...
        return AddBilateralSessionCoupon.fromJson(data);
      } else if (data['code'] == 0) {
        EasyLoading.dismiss();
