class GetAvailableBilateralSessionDoctor {
  List<BilateralSessionDoctors>? data;
  String? msg;
  int? code;

  GetAvailableBilateralSessionDoctor({this.data, this.msg, this.code});

  GetAvailableBilateralSessionDoctor.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <BilateralSessionDoctors>[];
      json['data'].forEach((v) {
        data!.add(BilateralSessionDoctors.fromJson(v));
      });
    }
    msg = json['msg'];
    code = json['code'];
...
class BilateralSessionDoctors {
  ...
  BilateralSessionDoctors.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
