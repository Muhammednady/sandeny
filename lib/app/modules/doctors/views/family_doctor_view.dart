...
class FamilyDoctorView extends GetView {
  const FamilyDoctorView({Key? key}) : super(key: key);
  @override
        ...
        child: Obx(
          () {
            ...
            return SizedBox(
              height: Get.height,
              width: Get.width * 0.8,
              child: controller.familyDoctorsList.isEmpty
                  ? Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          ButtonsManager.primaryButton(
                            text: 'try_again'.tr,
                            onPressed: () async {
                              await controller.getFamilyDoctors();
                            },
                            context: context,
                      ...
                      builder: (context, constraints) => SizedBox(
                        ...
                        child: LazyLoadScrollView(
                          ...
                          child: ListView.separated(
                            shrinkWrap: true,
                            itemCount: controller.familyDoctorsList.length,
                                      ...
                                      children: [
                                            ...
                                            Column(
                                              children: [
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    "${controller.familyDoctorsList[index].doctor!.fname!} ${controller.familyDoctorsList[index].doctor!.lname!}",
                                        ...
                                        Padding(
                                          ...
                                          child: Row(children: [
                                            ...
                                            Text(
                                              '${'5/'.tr}${controller.familyDoctorsList[index].ratingPercentage!.toStringAsFixed(2)}',
                                              style: getRegularStyle(
                                                color: Colors.grey,
