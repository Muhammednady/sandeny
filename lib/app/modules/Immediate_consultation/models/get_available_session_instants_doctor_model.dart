class GetAvailableICDoctors {
  List<ImmediateConsultationDoctors>? data;
  String? msg;
  int? code;

  GetAvailableICDoctors({this.data, this.msg, this.code});

  GetAvailableICDoctors.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <ImmediateConsultationDoctors>[];
      json['data'].forEach((v) {
        data!.add(ImmediateConsultationDoctors.fromJson(v));
      });
    }
    msg = json['msg'];
    code = json['code'];
...
class ImmediateConsultationDoctors {
  int? id;
  String? name;
  String? rateAvg;
  ...
  ImmediateConsultationDoctors.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
