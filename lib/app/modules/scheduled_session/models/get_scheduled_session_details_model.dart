class GetScheduledSessionDetailsModel {
  Data? data;
  String? msg;
  int? code;

  GetScheduledSessionDetailsModel({this.data, this.msg, this.code});

  GetScheduledSessionDetailsModel.fromJson(Map<String, dynamic> json) {
