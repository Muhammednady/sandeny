...
import 'booking_scheduled_session_view.dart';

class GetAvailableSSDoctorView extends GetView<ScheduledSessionController> {
  const GetAvailableSSDoctorView({Key? key}) : super(key: key);
  @override
                                              ...
                                              onPressed: () {
                                                ...
                                                controller.doctorId.value =
                                                    controller
                                                        ...
                                                        .id!;
                                                Get.to(() =>
                                                    const BookingScheduledSessionView());
                                              },
                                              context: context,
